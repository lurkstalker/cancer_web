...
# It's strongly recommended that you check this file into your version control system.
    ...
    ActiveRecord::Schema.define(version: 0) do
      ...
      create_table "cancer_targets", id: false, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
      ...
      create_table "civics", id: false, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
        ...
        t.timestamp "last_review_date", default: -> { "CURRENT_TIMESTAMP" }, null: false
      ...
      create_table "dgidbs", id: :integer, default: nil, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
      ...
      create_table "gdkds", id: false, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
        t.integer "id"
      ...
      create_table "mycanergenome_helper_results", primary_key: ["id", "num_ref"], mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
        t.integer "id", null: false
        t.string "num_ref", limit: 10, null: false
      end

      create_table "mycanergenome_helpers", primary_key: "num_ref", id: :string, limit: 60, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
        t.string "paper_name", limit: 250, null: false
        t.integer "pubmed_id", null: false
        t.string "web_address", limit: 150, null: false
      end

      create_table "mycanergenome_numbers", id: :integer, default: nil, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
      end

      create_table "mycanergenomes", id: :integer, default: nil, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
      ...
      create_table "oncokbs", id: :integer, default: nil, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
      ...
      create_table "pmkbs", id: false, mysql_options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
        t.string "gene_symbol", limit: 20, null: false
        t.string "gene_hgnc_id", limit: 40, null: false
